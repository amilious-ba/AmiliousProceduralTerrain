...
namespace Amilious.Core.Structs {
    ...
    public struct DistanceValue : IDistanceProvider<float> {
        ...
        /// <summary>
        /// This method is used to check if this 
        /// </summary>
        ...
        /// <returns></returns>
        public static bool operator == (DistanceValue a, DistanceValue b) => a.Equals(b);
        ...
        public static bool operator !=(DistanceValue a, DistanceValue b) => !(a == b);
