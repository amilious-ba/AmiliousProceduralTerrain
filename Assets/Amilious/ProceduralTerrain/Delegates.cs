...
namespace Amilious.ProceduralTerrain {
    ...
    /// <param name="chunkPoolInfo">The chunk pool info that was used for the update.</param>
    /// <param name="ms">The time the update took in milliseconds.</param>
    /// </summary>
    public delegate void OnChunksUpdatedDelegate(PoolInfo chunkPoolInfo, long ms);
